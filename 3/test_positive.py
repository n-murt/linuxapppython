...
class TestPositive:
    ...
    def test_step1(self, make_bad_arx):
        ...
        result1 = checkout(
            "cd {}; 7z a -t{} {}/arx2".format(data["folder_in"], data["type"], data["folder_out"]), "Everything is Ok")
    ...
    def test_step2(self, make_files):
        ...
        result1 = checkout(
            "cd {}; 7z e arx2.{} -o{} -y".format(data["folder_out"], data["type"], data["folder_ext1"]),
            "Everything is Ok")
        result2 = checkout("cd {}; ls".format(data["folder_ext1"]), make_files[0])
    ...
    def test_step3_1(self):
        # test3 =========show info about arx2.7z
        assert checkout("cd {}; 7z l arx2.{}".format(data["folder_out"], data["type"]),
                        "Name"), "Test3_1 FAIL"
